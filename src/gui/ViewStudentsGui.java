...
public class ViewStudentsGui extends JFrame {
    ...
    public void addGuiComponents(){
        JLabel viewRegistered = new JLabel("Visualizando Alunos Cadastrados");
        ...
        updateButton.addActionListener(e -> {
            JDBC.atualizarDados("alunos");
            modeloTabela.setRowCount(0);
            JDBC.carregarDadosdoJDBC(modeloTabela, "alunos");
        });
